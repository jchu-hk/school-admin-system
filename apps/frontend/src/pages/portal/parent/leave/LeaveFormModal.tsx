...
import type { ParentLeaveType, ParentLeaveFormData } from './api';
    ...
    <div className="pl-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="pl-modal__header">
          <h2 className="pl-modal__title">提交请假申请</h2>
          <button
        ...
        <form className="pl-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="pl-form__field pl-form__date-row">
            <div className="pl-form__date-group">
              <label className="pl-form__label" htmlFor="pl-start-date">
                开始日期 *
              </label>
              <input
                id="pl-start-date"
            ...
            <div className="pl-form__date-group">
              <label className="pl-form__label" htmlFor="pl-end-date">
                结束日期 *
              </label>
              <input
                id="pl-end-date"
          ...
          {/* ── 请假原因 ── */}
          <div className="pl-form__field">
            <label className="pl-form__label" htmlFor="pl-reason">
              请假原因 *
            </label>
            <textarea
              id="pl-reason"
          ...
          {/* ── 联系电话 ── */}
          <div className="pl-form__field">
            <label className="pl-form__label" htmlFor="pl-phone">
              联系电话（可选）
            </label>
            <input
              id="pl-phone"
