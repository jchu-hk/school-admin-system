...
export class Budget {
  ...
  @Column({ name: 'approved_amount', type: 'decimal', precision: 14, scale: 2, default: 0 })
  ...
  @Column({ name: 'actual_spent', type: 'decimal', precision: 14, scale: 2, default: 0 })
  actualSpent: number;
  ...
  @Column({ type: 'decimal', precision: 5, scale: 2, default: 0, name: 'overspend_threshold' })
...
export class AnnualBudget {
  ...
  /** 总批准预算 */
  @Column({ name: 'total_allocated', type: 'decimal', precision: 16, scale: 2, default: 0 })
  totalAllocated: number;

  /** 总已支出 */
  @Column({ name: 'total_spent', type: 'decimal', precision: 16, scale: 2, default: 0 })
  totalSpent: number;

  /** 总剩余 */
  @Column({ name: 'total_remaining', type: 'decimal', precision: 16, scale: 2, default: 0 })
...
export class BudgetAllocation {
  ...
  @Column({ type: 'decimal', precision: 5, scale: 2, default: 80, name: 'overspend_threshold' })
  overspendThreshold: number;
