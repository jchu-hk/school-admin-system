...
export class CreateExamDto {
  ...
  @ApiPropertyOptional({ description: '考试类型', enum: ExamType, default: ExamType.TEST })
  @IsOptional()
  @IsEnum(ExamType)
  examType?: ExamType;

  @ApiPropertyOptional({ description: '考试状态', enum: ExamStatus, default: ExamStatus.SCHEDULED })
  @IsOptional()
  @IsEnum(ExamStatus)
  status?: ExamStatus;
