...
> **主Wiki（英文，持续更新）**: `../../PROJECT-WIKI.md` | 静态常查阅资料集成页 | **版本**: v1.6.0 | **最后更新**: 2026-07-13 19:51 (GMT+8)
> ⚠️ **Coze环境不是我们管理的，代码可能不是最新**
...
|------|------|------------|----------|
| 后端 | v1.6.0 | `9241a83` | 2026-07-13 19:51 |
| 前端 | v1.6.0 | `9241a83` | 2026-07-13 19:51 |
| 数据库 | v1.6.0 | - | 2026-07-13 |

**代码基线**: https://github.com/jchu-hk/school-admin-system/commit/9241a83
**最新Tag**: v1.6.0
