...
import { CreateSchoolInfoDto, UpdateSchoolInfoDto, SchoolInfoQueryDto } from './dto/school-info.dto';
...
export class SchoolInfoController {
  ...
  @Roles(UserRole.SYSTEM_ADMIN, UserRole.SCHOOL_DIRECTOR, UserRole.SCHOOL_STAFF, UserRole.TEACHER, UserRole.PARENT, UserRole.STUDENT)
  findActive() {
  ...
  @ApiResponse({ status: 200, description: '获取学校详情成功', type: SchoolInfo })
  @Roles(UserRole.SYSTEM_ADMIN, UserRole.SCHOOL_DIRECTOR, UserRole.SCHOOL_STAFF, UserRole.TEACHER)
  ...
  create(@Body() dto: CreateSchoolInfoDto, @Request() req: any) {
  ...
  update(@Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateSchoolInfoDto, @Request() req: any) {
