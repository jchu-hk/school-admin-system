    ...
    <div className="space-y-6">
      ...
      {activeTab === 'users' ? (
        <>
          ...
          {/* Table */}
          <div data-testid="user-section" className="bg-white rounded-xl shadow overflow-hidden">
            <div className="overflow-x-auto">
              <table data-testid="user-table" className="w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {loading ? (
                    ...
                    users.map((user) => (
                      <tr key={user.id} data-testid="user-row" className="hover:bg-gray-50 transition cursor-pointer">
